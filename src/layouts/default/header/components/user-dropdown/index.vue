  ...
  <Dropdown placement="bottomLeft" :overlayClassName="`${prefixCls}-dropdown-overlay`">
    ...
    <template #overlay>
      <Menu @click="handleMenuClick">
        ...
        />
        <MenuItem key="usercenter" text="个人中心" icon="ant-design:user-outlined" />
        <MenuItem key="updatePwd" text="修改密码" icon="ant-design:safety-certificate-outlined" />
        <MenuItem
          v-if="getUseLockPage"
          key="lock"
...
<script lang="ts" setup>
  ...
  type MenuEvent = 'logout' | 'doc' | 'lock' | 'api' | 'usercenter' | 'updatePwd';
